                                    ...
                                    <div class="ttmonan">
                                        ...
                                        <form method="post" action="">
                                            <div class="tt_nut">
												...
												<input type="date" id="disabledInput" name="disabledInput" value="'.$_SESSION['ngay'].'" disabled style="width:105px">                                       <button name="nut" id="nut" value="Thêm">Thêm vào giỏ hàng</button>
                                            </div>
                                        </form>
                                        <hr>
