...
<!--===================HEADER=====================-->
        <div class="header">
            <div class="row">
                <div class="logo col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12 mt-3">
                    <a href="../QuanLyBepAn/trang-chu.php"><img src="img/logo.jpg" alt="logo" width="120"></a>
                </div>
        
                <div class="search col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 mt-5">
                    <form action="../QuanLyBepAn/thucdon-user.php" method="get" class="form_tmkiem">
                ...
                <div class="login col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 mt-5">
                    ...
                    if (isset($_SESSION['user'])) {
                        ...
                        echo '<form action="../QuanLyBepAn/dang-xuat.php" method="post">';
                        echo '<button class="nut_dangnhap" type="submit" name="submit">Đăng xuất</button>';
                        echo '</form>';
                    } else {
                        echo '<a href="../QuanLyBepAn/dang-nhap.php"><button class="nut_dangnhap" type="submit" name="submit">Đăng nhập</button></a>';
                    }
                    ?>
                    <a href="gio-hang.php">
        ...
        <div class="row">
            <div class="menu">
                <ul class="">
                    <li><a href="../QuanLyBepAn/trang-chu.php">TRANG CHỦ</a></li>
                    <li><a href="../QuanLyBepAn/thucdon-user.php">THỰC ĐƠN</a></li>
                    <li><a href="../QuanLyBepAn/tin-tuc.php">TIN TỨC</a></li>
                    <li><a href="../QuanLyBepAn/gioi-thieu.php">GIỚI THIỆU</a></li>
                    <li><a href="suat-an.php">SUẤT ĂN</a></li>
                    <?php
                        if ($_SESSION['phanquyen'] == 1) {
                            echo '<li><a href="../QuanLyBepAn/trang-quan-ly.php">TRANG QUẢN LÝ</a></li>';
                        }
						else if($_SESSION['phanquyen'] == 3)
						{
							echo '<li><a href="../QuanLyBepAn/trang-che-bien.php">TRANG CHẾ BIẾN</a></li>';
						}
                    ?>
                </ul>
            </div>
